                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                                name="name" value="{{ old('name', $montir->user->name) }}" tabindex="1">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <select name="jenis_kelamin" id="jenis_kelamin"
                                ...
                                <option value="L"
                                    {{ old('jenis_kelamin', $montir->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-Laki
                                </option>
                                <option value="P"
                                    {{ old('jenis_kelamin', $montir->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan
                                </option>
                            </select>
                            @error('jenis_kelamin')
                                <div class="invalid-feedback">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input id="email" type="email" class="form-control @error('email') is-invalid @enderror"
                                name="email" value="{{ old('email', $montir->user->email) }}" tabindex="2">
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input id="no_hp" type="text" class="form-control @error('no_hp') is-invalid @enderror"
                                name="no_hp" value="{{ old('no_hp', $montir->no_hp) }}" tabindex="4">
                            @error('no_hp')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <textarea id="alamat" name="alamat" class="form-control @error('alamat') is-invalid @enderror" tabindex="8">{{ old('alamat', $montir->alamat) }}</textarea>
                            @error('alamat')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
